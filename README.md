...
|---|---|
| ![Home challenges](docs/screenshots/home-challenges.png) | ![Challenge builder empty](docs/screenshots/challenge-builder-empty.png) |

| Challenge Builder Configured | Activities |
|---|---|
| ![Challenge builder filled](docs/screenshots/challenge-builder-filled.png) | ![Challenge activities](docs/screenshots/challenge-activities.png) |

| Games | Activity Levels |
|---|---|
| ![Challenge games](docs/screenshots/challenge-games.png) | ![Activity levels](docs/screenshots/activity-levels.png) |

### Analytics

| Overview Analytics | Activity Analytics | Mistake Analytics |
|---|---|---|
| ![Overview analytics](docs/screenshots/analytics-overview.png) | ![Activity analytics](docs/screenshots/analytics-activities.png) | ![Mistake analytics](docs/screenshots/analytics-mistakes.png) |
...
|---|---|
| ![Tic-tac-toe settings](docs/screenshots/tic-tac-toe-settings.png) | ![Settings](docs/screenshots/settings.png) |
